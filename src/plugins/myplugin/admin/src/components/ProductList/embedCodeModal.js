          ...
          <ModalBody>
            ...
            >
              <Typography>
                ...
                <script
                  ...
                  src="${window.location.origin}/plugins/myplugin/static/stripe.js"
                >
            ...
            >
              <Typography>
                {`const response = await axios.get(
                   " ${window.location.origin}/myplugin/getProduct/${productId}"
                  ) `}
              </Typography>
            </Box>
            ...
            >
              ...
              <Typography>
                ...
                }/myplugin/retrieveCheckoutSession/${"$"}{checkoutSessionId}
                    )
                   `}
              </Typography>
            </Box>
